...
public class LevelSelect : MonoBehaviour 
{
	...
	{	
		...
		GameObject PlayerSaveObj = GameObject.Find("Save");
		...
		Lvl0.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 0 );
		...
		Tier1LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 5 );
		...
		Tier1LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 10 );
		...
		Tier2LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 15 );
		...
		Tier2LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 20 );
		...
		Tier2LvlC.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 25 );
		...
		Tier3LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 30 );
		...
		Tier3LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 35 );
		...
		Tier4LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 40 );
		...
		Tier4LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 45 );
		...
		Tier4LvlC.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 50 );
		...
		Tier5.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 1, 55 );
		...
		S2Tier1LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 2, 0 );
		...
		S2Tier1LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 2, 5 );
		...
		S2Tier2LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 2, 10 );
		...
		S2Tier2LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 2, 15 );
		...
		S2Tier2LvlC.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 2, 20 );
		...
		S2Tier3LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 2, 25 );
		...
		S2Tier3LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 2, 30 );
		...
		S2Tier4LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 2, 35 );
		...
		S2Tier4LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 2, 40 );
		...
		S2Tier4LvlC.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 2, 45 );
		...
		S2Tier5.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 2, 50 );
		...
		S3Tier1LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 3, 0 );
		...
		S3Tier1LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 3, 5 );
		...
		S3Tier2LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 3, 10 );
		...
		S3Tier2LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 3, 15 );
		...
		S3Tier2LvlC.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 3, 20 );
		...
		S3Tier3LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 3, 25 );
		...
		S3Tier3LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 3, 30 );
		...
		S3Tier4LvlA.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 3, 35 );
		...
		S3Tier4LvlB.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 3, 40 );
		...
		S3Tier4LvlC.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 3, 45 );
		...
		S3Tier5.onTouchUpInside += sender => PlayerSaveObj.GetComponent<PlayerSave>().SetStage( 3, 50 );
